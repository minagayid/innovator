...
| [`simulation/`](simulation/) | Reproducible road, static-lift, buoyancy, shallow-recovery and single-fault supervisor screens, with controls and JSON/plot evidence. |
| [`schematics/`](schematics/) | Rendered common-capsule, fail-closed supervisor and qualification-sequence technical schematics. |
