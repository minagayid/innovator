# External constraints ledger — MEL-SHIELD

| ID | Constraint or evidence | Consequence | Label |
|---|---|---|---|
| R1 | Ionizing radiation changed melanin electron-spin/electron-transfer behavior in a laboratory study; melanized fungi showed growth effects under stated conditions. [1] | Supports a material-interaction hypothesis, not radiation destruction or useful power. | [S] |
...
This is not a systematic radiation-transport review, materials qualification, patent search or regulatory determination. No specific mission spectrum, dose limit, geometry, payload, manufacturing route or jurisdiction was supplied. Those missing inputs prevent a release or deployment claim.

## References

[1] [Dadachova et al., *PLOS ONE* (2007).](https://journals.plos.org/plosone/article?id=10.1371%2Fjournal.pone.0000457)

[2] [NASA Science, melanin and DNA repair investigation.](https://science.nasa.gov/biological-physical/investigations/melanin-and-dna-repair/)
