...
description: Rapidly triage an incoming NDA and classify it as GREEN (standard approval),
  ...
  from sales or business development, when screening for embedded non-solicits, non-competes,
  or missing carveouts, or when deciding whether an NDA can be signed under standard
  delegation.
metadata:
