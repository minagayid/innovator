...
description: Design and draft multi-email sequences with full copy, timing, branching
  ...
  lead nurture, re-engagement, win-back, or product launch flows, when you need a
  complete drip campaign with A/B test suggestions, or when mapping a sequence end-to-end
  with a flow diagram.
metadata:
