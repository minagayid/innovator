...
description: Understand, inspect, or programmatically transform existing images. Use
  when the task requires describing or answering questions about an image, performing
  deterministic image manipulation such as downscaling, cropping, format conversion,
  or compression, or running traditional computer vision operations.
---
