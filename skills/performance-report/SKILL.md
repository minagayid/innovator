...
description: Build a marketing performance report with key metrics, trend analysis,
  ...
  a campaign, when preparing weekly, monthly, or quarterly channel summaries for stakeholders,
  or when you need data translated into an executive summary with next-period priorities.
metadata:
